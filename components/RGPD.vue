<template>
  <div>
    <h2>Définitions</h2>
    <p>
      <b>Client&nbsp;:</b>&nbsp;tout professionnel ou personne physique capable
      au sens des articles 1123 et suivants du Code civil, ou personne morale,
      qui visite le Site objet des présentes conditions générales.<br />
      <b>Prestations et Services&nbsp;:</b>
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a> met à disposition
      des Clients&nbsp;:
    </p>
    ...
    <p>
      ...
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a> pour la gestion de
    ...
    <p>
      ...
      site internet&nbsp;<a href="https://www.zarbo.fr">https://www.zarbo.fr</a
      >&nbsp;l'identité des différents intervenants dans le cadre de sa
      réalisation et de son suivi:
    </p>
    <p>
      <strong>Propriétaire</strong> : Thierry Guedj – 11, route du Castera 31310
      Montesquieu Volvestre<br />

      <strong>Responsable publication</strong> : Thierry Guedj –
      info@zarbo.fr<br />
      Le responsable publication est une personne physique ou une personne
      morale.<br />
      <strong>Webmaster</strong> : Thierry Guedj – info@zarbo.fr<br />
      <strong>Hébergeur</strong> : ovh – 2 rue Kellermann 59100 Roubaix 1007<br />
      <strong>Délégué à la protection des données</strong> : Thierry Guedj –
      info@zarbo.fr<br />
    </p>
    ...
    <p>
      L’utilisation du site&nbsp;<a href="https://www.zarbo.fr"
        >https://www.zarbo.fr</a
      ...
      utilisateurs du site&nbsp;<a href="https://www.zarbo.fr"
        >https://www.zarbo.fr</a
    ...
    <p>
      ...
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a>, qui s’efforcera
      alors de communiquer préalablement aux utilisateurs les dates et heures de
      l’intervention. Le site web&nbsp;<a href="https://www.zarbo.fr"
        >https://www.zarbo.fr</a
      >&nbsp;est mis à jour régulièrement par
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a> responsable. De la
    ...
    <p>
      Le site internet&nbsp;<a href="https://www.zarbo.fr"
        >https://www.zarbo.fr</a
      >&nbsp;a pour objet de fournir une information concernant l’ensemble des
      activités de la société.
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a> s’efforce de
      fournir sur le site&nbsp;<a href="https://www.zarbo.fr"
        >https://www.zarbo.fr</a
      >&nbsp;des informations aussi précises que possible. Toutefois, il ne
      pourra être tenu responsable des oublis, des inexactitudes et des carences
    ...
    <p>
      ...
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a> est hébergé chez
    ...
    <p>
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a> et l’hébergeur ne
    ...
    <p>
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a> est propriétaire
      des droits de propriété intellectuelle et détient les droits d’usage sur
      tous les éléments accessibles sur le site internet, notamment les textes,
      ...
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a>.
    </p>
    ...
    <p>
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a> agit en tant
      qu’éditeur du site.
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a> &nbsp;est
      responsable de la qualité et de la véracité du Contenu qu’il publie.
    </p>

    <p>
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a> ne pourra être
      tenu responsable des dommages directs et indirects causés au matériel de
      l’utilisateur, lors de l’accès au site internet
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a>, et résultant soit
    ...
    <p>
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a> ne pourra
      ...
      du site&nbsp;<a href="https://www.zarbo.fr">https://www.zarbo.fr</a>. Des
      espaces interactifs (possibilité de poser des questions dans l’espace
      contact) sont à la disposition des utilisateurs.
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a> se réserve le
      ...
      cas échéant, <a href="https://www.zarbo.fr">https://www.zarbo.fr</a> se
    ...
    <p>
      ...
      responsable du traitement des Données Personnelles est : Thierry Guedj.
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a>est représenté par
      Thierry Guedj, son représentant légal
    </p>

    <p>
      En tant que responsable du traitement des données qu’il collecte,
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a> s’engage à
      ...
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a> traite des Données
      Personnelles,
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a> prend toutes les
      ...
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a> les traite.
    </p>
    &nbsp;
    <h3>7.2 Finalité des données collectées</h3>
    &nbsp;
    <p>
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a> est susceptible de
    ...
    <ul>
      ...
      <li>
        ...
        <a href="https://www.zarbo.fr">https://www.zarbo.fr</a> : adresse email
      </li>
      <li>
    ...
    <p>
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a> ne commercialise
    ...
    <p>
      ...
      de <a href="https://www.zarbo.fr">https://www.zarbo.fr</a> disposent des
      droits suivants :
    </p>
    &nbsp;
    <ul>
      ...
      <li>
        ...
        de choisir à qui
        <a href="https://www.zarbo.fr">https://www.zarbo.fr</a> devra
    ...
    <p>
      Dès que <a href="https://www.zarbo.fr">https://www.zarbo.fr</a> a
      connaissance du décès d’un Utilisateur et à défaut d’instructions de sa
      part, <a href="https://www.zarbo.fr">https://www.zarbo.fr</a> s’engage à
    ...
    <p>
      ...
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a> utilise ses
      Données Personnelles, demander à les rectifier ou s’oppose à leur
      traitement, l’Utilisateur peut contacter
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a> par écrit à
      l’adresse suivante :
    </p>
    &nbsp; Thierry Guedj – DPO, Thierry Guedj <br />
    11, route du Castera 31310 Montesquieu Volvestre. &nbsp;
    <p>
      Dans ce cas, l’Utilisateur doit indiquer les Données Personnelles qu’il
      souhaiterait que
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a> corrige, mette à
      jour ou supprime, en s’identifiant précisément avec une copie d’une pièce
    ...
    <p>
      ...
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a> par la loi,
      notamment en matière de conservation ou d’archivage des documents. Enfin,
      les Utilisateurs de
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a> peuvent déposer
    ...
    <p>
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a> s’interdit de
      ...
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a> reste libre du
    ...
    <p>
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a> s’engage à prendre
      ...
      connaissance de <a href="https://www.zarbo.fr">https://www.zarbo.fr</a>,
      ...
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a> ne collecte aucune
      «&nbsp;données sensibles&nbsp;».
    </p>

    <p>
      Les Données Personnelles de l’Utilisateur peuvent être traitées par des
      filiales de <a href="https://www.zarbo.fr">https://www.zarbo.fr</a> et des
    ...
    <p>
      ...
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a> sont
    ...
    <p>
      ...
      du rachat de <a href="https://www.zarbo.fr">https://www.zarbo.fr</a> et de
    ...
    <p>
      ...
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a> utilise des
    ...
    <p>
      Le site&nbsp;<a href="https://www.zarbo.fr">https://www.zarbo.fr</a
      >&nbsp;contient un certain nombre de liens hypertextes vers d’autres
      sites, mis en place avec l’autorisation de
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a>. Cependant,
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a> n’a pas la
    ...
    <p>
      ...
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a> d’améliorer le
    ...
    <p>
      ...
      son terminal.
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a> informe
    ...
    <p>
      ...
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a> ou l’un de ses
    ...
    <p>
      Le cas échéant,
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a> décline toute
      responsabilité pour les conséquences liées au fonctionnement dégradé du
      Site et des services éventuellement proposés par
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a>, résultant (i) du
      refus de Cookies par l’Utilisateur (ii) de l’impossibilité pour
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a> d’enregistrer ou
    ...
    <p>
      ...
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a> pourra en outre
    ...
    <p>
      ...
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a> ou dans son
      ...
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a>, Twitter,
    ...
    <p>
      ...
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a>. À tout moment,
      l’Utilisateur peut néanmoins revenir sur son consentement à ce que
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a> dépose ce type de
      cookies.
    </p>
    &nbsp;
    ...
    <p>
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a> peut employer
    ...
    <p>
      ...
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a> d’évaluer les
    ...
    <p>
      ...
      <a href="https://www.zarbo.fr">https://www.zarbo.fr</a>, et fournir
