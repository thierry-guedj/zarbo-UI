<template>
  <section>
    ...
    <v-card-text>
      <div v-if="success">
        <v-alert class="alert-success text-center" transition="scale-transition" border="right">
          {{ status }}
      ...
      <div v-else>
        <v-alert class="alert-error" icon="announcement" transition="scale-transition" border="right">
          <div>
            {{ status }}
