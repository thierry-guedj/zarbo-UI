  ...
  <section>
      ...
      <section class="hero text-white">
        <v-row class="row-md-12">
          <v-col class="col-md-2 text-center iconTitle">
            <img src="/privacyIcon.png" class="ml-3 mr-2"
          /></v-col>
    ...
    <div class="px-5">
      ...
      <p>
        ...
        <a href="https://zarbo.fr">https://zarbo.fr</a>est représenté par
        Thierry Guedj, son représentant légal
      </p>

      <p>
        En tant que responsable du traitement des données qu’il collecte,
        <a href="https://zarbo.fr">https://zarbo.fr</a> s’engage à respecter le
        ...
        <a href="https://zarbo.fr">https://zarbo.fr</a> traite des Données
        Personnelles, <a href="https://zarbo.fr">https://zarbo.fr</a> prend
        ...
        lesquelles <a href="https://zarbo.fr">https://zarbo.fr</a> les traite.
      </p>
      &nbsp;
      <h3>1.2 Finalité des données collectées</h3>
      &nbsp;
      <p>
        <a href="https://zarbo.fr">https://zarbo.fr</a> est susceptible de
      ...
      <p>
        <a href="https://zarbo.fr">https://zarbo.fr</a> ne commercialise pas vos
        données personnelles qui sont donc uniquement utilisées par nécessité ou
        à des fins statistiques et d’analyses.
      </p>
      &nbsp;
      ...
      <p>
        ...
        de <a href="https://zarbo.fr">https://zarbo.fr</a> disposent des droits
        suivants :
      </p>
      &nbsp;
      <ul>
        ...
        <li>
          ...
          et de choisir à qui
          <a href="https://zarbo.fr">https://zarbo.fr</a> devra communiquer (ou
      ...
      <p>
        Dès que <a href="https://zarbo.fr">https://zarbo.fr</a> a connaissance
        du décès d’un Utilisateur et à défaut d’instructions de sa part,
        <a href="https://zarbo.fr">https://zarbo.fr</a> s’engage à détruire ses
      ...
      <p>
        ...
        <a href="https://zarbo.fr">https://zarbo.fr</a> utilise ses Données
        Personnelles, demander à les rectifier ou s’oppose à leur traitement,
        l’Utilisateur peut contacter
        <a href="https://zarbo.fr">https://zarbo.fr</a> par écrit à l’adresse
        suivante :
      </p>
      ...
      <p>
        ...
        souhaiterait que
        <a href="https://zarbo.fr">https://zarbo.fr</a> corrige, mette à jour ou
      ...
      <p>
        ...
        <a href="https://zarbo.fr">https://zarbo.fr</a> par la loi, notamment en
        matière de conservation ou d’archivage des documents. Enfin, les
        Utilisateurs de <a href="https://zarbo.fr">https://zarbo.fr</a> peuvent
      ...
      <p>
        <a href="https://zarbo.fr">https://zarbo.fr</a> s’interdit de traiter,
        héberger ou transférer les Informations collectées sur ses Clients vers
        un pays situé en dehors de l’Union européenne ou reconnu comme
        «&nbsp;non adéquat&nbsp;» par la Commission européenne sans en informer
        préalablement le client. Pour autant,
        <a href="https://zarbo.fr">https://zarbo.fr</a> reste libre du choix de
      ...
      <p>
        <a href="https://zarbo.fr">https://zarbo.fr</a> s’engage à prendre
        ...
        à la connaissance de <a href="https://zarbo.fr">https://zarbo.fr</a>,
        ...
        <a href="https://zarbo.fr">https://zarbo.fr</a> ne collecte aucune
        «&nbsp;données sensibles&nbsp;».
      </p>

      <p>
        Les Données Personnelles de l’Utilisateur peuvent être traitées par des
        filiales de <a href="https://zarbo.fr">https://zarbo.fr</a> et des
      ...
      <p>
        ...
        <a href="https://zarbo.fr">https://zarbo.fr</a> sont principalement les
      ...
      <p>
        ...
        du rachat de <a href="https://zarbo.fr">https://zarbo.fr</a> et de ses
        ...
        du site&nbsp;<a href="https://zarbo.fr">https://zarbo.fr</a>.
      </p>
      ...
      <p>
        ...
        <a href="https://zarbo.fr">https://zarbo.fr</a> utilise des réseaux
      ...
      <p>
        ...
        <a href="https://zarbo.fr">https://zarbo.fr</a>prend toutes les mesures
      ...
      <p>
        Le site&nbsp;<a href="https://zarbo.fr">https://zarbo.fr</a
        >&nbsp;contient un certain nombre de liens hypertextes vers d’autres
        sites, mis en place avec l’autorisation de
        <a href="https://zarbo.fr">https://zarbo.fr</a>. Cependant,
        <a href="https://zarbo.fr">https://zarbo.fr</a> n’a pas la possibilité
      ...
      <p>
        ...
        <a href="https://zarbo.fr">https://zarbo.fr</a> d’améliorer le contenu
      ...
      <p>
        ...
        <a href="https://zarbo.fr">https://zarbo.fr</a> informe l’Utilisateur
      ...
      <p>
        ...
        être le cas lorsque
        <a href="https://zarbo.fr">https://zarbo.fr</a> ou l’un de ses
      ...
      <p>
        ...
        <a href="https://zarbo.fr">https://zarbo.fr</a> pourra en outre faire
      ...
      <p>
        ...
        <a href="https://zarbo.fr">https://zarbo.fr</a> ou dans son application
        mobile et si l’Utilisateur a accepté le dépôt de cookies en poursuivant
        sa navigation sur le Site Internet ou l’application mobile de
        <a href="https://zarbo.fr">https://zarbo.fr</a>, Twitter, Facebook,
      ...
      <p>
        ...
        <a href="https://zarbo.fr">https://zarbo.fr</a>. À tout moment,
        l’Utilisateur peut néanmoins revenir sur son consentement à ce que
        <a href="https://zarbo.fr">https://zarbo.fr</a> dépose ce type de
        cookies.
      </p>
      &nbsp;
      ...
      <p>
        <a href="https://zarbo.fr">https://zarbo.fr</a> peut employer
      ...
      <p>
        ...
        <a href="https://zarbo.fr">https://zarbo.fr</a> d’évaluer les réponses
